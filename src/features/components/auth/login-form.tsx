...
import { Eye, EyeOff, ArrowLeft, Zap, Lock, Sun, Moon } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Center: Large Italic Serif Statement */}
        <div className="my-auto z-10 max-w-xl">
          ...
          >
            &ldquo;Focus on the work. Let Velox handle the flow.&rdquo;
          </blockquote>

          <p className="mt-4 text-xs uppercase tracking-[0.25em] text-white/45 font-semibold font-mono">
            Velox Workspace • Node Engine
          </p>
        </div>

        {/* Bottom Attribution / Footer Note */}
        ...
        <div className="my-auto w-full max-w-[360px] mx-auto py-1">
          <Card className="border-0 shadow-none bg-transparent">
            <CardHeader className="text-center p-0 mb-2">
              ...
              <CardDescription className="text-sm font-medium text-[var(--text-secondary)]">
               Workflow automation  {" "}
                <span className="font-bold text-[#D97736]">Tool.</span>
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="p-0">
              ...
              <div className="flex flex-col gap-2 mb-3">
                ...
                <Button
                  ...
                  className="w-full h-10 rounded-xl flex items-center justify-center gap-3 font-semibold text-xs sm:text-sm shadow-md transition-all duration-200 cursor-pointer disabled:opacity-60 bg-white text-black hover:bg-slate-100 hover:scale-[1.01]"
                >
                ...
                <Button
                  ...
                  className="w-full h-10 rounded-xl flex items-center justify-center gap-3 border font-semibold text-xs sm:text-sm transition-all duration-200 cursor-pointer disabled:opacity-60 hover:scale-[1.01]"
                  style={{
